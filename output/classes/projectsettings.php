...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "Localidades" ] = array( "url" => "localidades1", "type" => 6 );
	$projectEntitiesReverse[ "localidades1" ] = "Localidades";
	$projectEntities[ "Cable" ] = array( "url" => "cable", "type" => 6 );
	$projectEntitiesReverse[ "cable" ] = "Cable";
	$projectEntities[ "spliter" ] = array( "url" => "spliter", "type" => 6 );
	$projectEntitiesReverse[ "spliter" ] = "spliter";
	$projectEntities[ "ctos" ] = array( "url" => "ctos", "type" => 6 );
	$projectEntitiesReverse[ "ctos" ] = "ctos";
	$projectEntities[ "puertos" ] = array( "url" => "puertos", "type" => 6 );
	$projectEntitiesReverse[ "puertos" ] = "puertos";
